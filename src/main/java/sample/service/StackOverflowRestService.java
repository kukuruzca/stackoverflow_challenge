...
//    }
    ...
    public static void main(String... args) throws IOException, InterruptedException {
        ...
        StackExchangeService serice = new StackExchangeService("TnWGwQfIf9SAk3Gkz2H5Lw((");

        //add new fields in filter
        List<String> include = Arrays.asList("user.answer_count", "user.question_count");
        List<String> exclude = Arrays.asList();
        Filter filter = serice.createFilter(include, exclude, "default", false);
        ...
        while(hasMore)
        {
            CommonWrapperObject<User> commonWrapperObject = serice.getUsers(page, 223, filter);
                    ...
                    .forEach(x->
                            {
                                ...
                                try {
                                    List<String> usertags = serice.getAllUserTags(x.user_id);
